    ...
    return (
        ...
        <>
            ...
            <div className="px-6">
                ...
                <div onClick={() => setIsOpen(!isOpen)} className={` ${isOpen ? " h-fit" : "h-[50px]"} overflow-hidden py-4`} >
                    ...
                    <div className="accBottom text-start">
                        <div className="flex items-center justify-between ">
                            ...
                            <p className="text-[#00AC73] font-semibold text-[16px] xs:text-[20px]">Доставлено</p>
                        </div>
